...
public class CourseDto {
    ...
    @NotNull(groups = {CourseValidationRules.Delete.class}, message = "Id must not be null")
    @Null(groups = {CourseValidationRules.Create.class}, message = "Id must be null")
    String id;

    @Length(max = 50)
    @Null(groups = {CourseValidationRules.Delete.class}, message = "title must be null")
    @NotNull(groups = {CourseValidationRules.Create.class}, message = "title must not be null")
    String title;

    @Length(max = 500)
    @Null(groups = {CourseValidationRules.Delete.class}, message = "description must be null")
    String description;
